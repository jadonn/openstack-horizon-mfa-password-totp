...
class Login(django_auth_forms.AuthenticationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        fields_ordering = ['username', 'password', 'totp', 'region']
        ...
        if settings.OPENSTACK_KEYSTONE_MFA_TOTP_ENABLED:
            self.fields['totp'] = forms.CharField(label=_("Time-based One Time Password"), widget=forms.PasswordInput(render_value=False), required=False)
            fields_ordering.append('totp')
